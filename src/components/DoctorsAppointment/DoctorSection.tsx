...
const DoctorSection: FunctionComponent = memo(() => {
  return (
    <div className={styles.frameParent}>
      ...
      <div className={styles.prototypeUserSurvey}>
        <div className={styles.cardAcordionParent}>
          ...
          <div className={styles.cardAcordion1}>
            <div className={styles.divsc1fegqzc10}>
